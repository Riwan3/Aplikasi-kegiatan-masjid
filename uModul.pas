...
type
  TDataModule1 = class(TDataModule)
    ...
    Qjamaahid_jamaah: TIntegerField;
    Qjamaahnama_jamaah: TWideStringField;
    Qjamaahtmp_lahir: TWideStringField;
    Qjamaahtgl_lahir: TDateField;
    Qjamaahjk: TWideStringField;
    Qjamaahno_transaksi: TIntegerField;
  private
